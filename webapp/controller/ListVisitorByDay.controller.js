sap.ui.define([
	...
	return Controller.extend("poc.zvms.controller.ListVisitorByDay", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf poc.zvms.view.ListVisitorByDay
		 */
		onInit: function () {
			var oModel = this.getOwnerComponent().getModel("VisitorByDaySet");
		...
		_onSearch: function (oEvt) {
			...
			var obinding = this.getView().byId("tblVisitorsByDay").getBinding("items");
